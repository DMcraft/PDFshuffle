...
class Ui_ScanerForm(object):
    def setupUi(self, ScanerForm):
        ...
        ScanerForm.setMinimumSize(QtCore.QSize(370, 420))
        ScanerForm.setMaximumSize(QtCore.QSize(370, 420))
        font = QtGui.QFont()
        ...
        self.groupBoxSample.setEnabled(True)
        self.groupBoxSample.setGeometry(QtCore.QRect(10, 290, 351, 91))
        self.groupBoxSample.setObjectName("groupBoxSample")
        self.pushButton_sample_list = QtWidgets.QPushButton(self.groupBoxSample)
        self.pushButton_sample_list.setGeometry(QtCore.QRect(10, 30, 101, 21))
        self.pushButton_sample_list.setObjectName("pushButton_sample_list")
        self.pushButton_sample_A4 = QtWidgets.QPushButton(self.groupBoxSample)
        self.pushButton_sample_A4.setGeometry(QtCore.QRect(120, 30, 111, 21))
        self.pushButton_sample_A4.setObjectName("pushButton_sample_A4")
        self.pushButton_sample = QtWidgets.QPushButton(self.groupBoxSample)
        self.pushButton_sample.setGeometry(QtCore.QRect(240, 30, 101, 21))
        ...
        self.lineEdit_message.setGeometry(QtCore.QRect(10, 390, 351, 21))
    ...
    def retranslateUi(self, ScanerForm):
        ...
        self.pushButton_sample_list.setText(_translate("ScanerForm", "Лист согл"))
        self.pushButton_sample_A4.setText(_translate("ScanerForm", "Планшет (PDF)"))
        self.pushButton_sample.setText(_translate("ScanerForm", "PushButton"))
