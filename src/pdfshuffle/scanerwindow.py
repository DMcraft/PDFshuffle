...
class Ui_ScanerForm(object):
    def setupUi(self, ScanerForm):
        ...
        ScanerForm.setEnabled(True)
        ScanerForm.resize(370, 520)
        ...
        ScanerForm.setMinimumSize(QtCore.QSize(370, 520))
        ScanerForm.setMaximumSize(QtCore.QSize(370, 520))
        font = QtGui.QFont()
        ...
        self.groupBoxSample.setGeometry(QtCore.QRect(10, 360, 351, 131))
        ...
        self.pushButton_exit.setGeometry(QtCore.QRect(280, 330, 81, 21))
        ...
        self.lineEdit_message.setGeometry(QtCore.QRect(10, 490, 351, 21))
        ...
        self.groupBoxSave.setGeometry(QtCore.QRect(10, 220, 351, 101))
        ...
        self.pushButton_save.setGeometry(QtCore.QRect(140, 330, 121, 21))
        self.pushButton_save.setObjectName("pushButton_save")
        self.pushButton_scan = QtWidgets.QPushButton(ScanerForm)
        self.pushButton_scan.setGeometry(QtCore.QRect(10, 330, 121, 21))
        self.pushButton_scan.setObjectName("pushButton_scan")
        self.checkBox_autosave = QtWidgets.QCheckBox(ScanerForm)
        self.checkBox_autosave.setGeometry(QtCore.QRect(230, 220, 131, 20))
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 110, 351, 101))
        self.groupBox.setFlat(False)
        self.groupBox.setCheckable(False)
        self.groupBox.setObjectName("groupBox")
        self.spinBox_left = QtWidgets.QSpinBox(self.groupBox)
        self.spinBox_left.setGeometry(QtCore.QRect(10, 70, 70, 21))
        self.spinBox_left.setWrapping(False)
        self.spinBox_left.setMaximum(420)
        self.spinBox_left.setObjectName("spinBox_left")
        self.comboBox_area = QtWidgets.QComboBox(self.groupBox)
        self.comboBox_area.setGeometry(QtCore.QRect(160, 30, 181, 21))
        self.comboBox_area.setObjectName("comboBox_area")
        self.spinBox_height = QtWidgets.QSpinBox(self.groupBox)
        self.spinBox_height.setGeometry(QtCore.QRect(270, 70, 70, 21))
        self.spinBox_height.setWrapping(False)
        self.spinBox_height.setMaximum(420)
        self.spinBox_height.setObjectName("spinBox_height")
        self.spinBox_upper = QtWidgets.QSpinBox(self.groupBox)
        self.spinBox_upper.setGeometry(QtCore.QRect(100, 70, 70, 21))
        self.spinBox_upper.setWrapping(False)
        self.spinBox_upper.setMaximum(420)
        self.spinBox_upper.setObjectName("spinBox_upper")
        self.label_3 = QtWidgets.QLabel(self.groupBox)
        self.label_3.setGeometry(QtCore.QRect(10, 30, 161, 22))
        self.label_3.setObjectName("label_3")
        self.spinBox_width = QtWidgets.QSpinBox(self.groupBox)
        self.spinBox_width.setGeometry(QtCore.QRect(190, 70, 70, 21))
        self.spinBox_width.setWrapping(False)
        self.spinBox_width.setMaximum(420)
        self.spinBox_width.setObjectName("spinBox_width")
        self.label_9 = QtWidgets.QLabel(self.groupBox)
        self.label_9.setGeometry(QtCore.QRect(10, 50, 67, 22))
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(self.groupBox)
        self.label_10.setGeometry(QtCore.QRect(100, 50, 67, 22))
        self.label_10.setObjectName("label_10")
        self.label_11 = QtWidgets.QLabel(self.groupBox)
        self.label_11.setGeometry(QtCore.QRect(190, 50, 67, 22))
        self.label_11.setObjectName("label_11")
        self.label_12 = QtWidgets.QLabel(self.groupBox)
        self.label_12.setGeometry(QtCore.QRect(270, 50, 67, 22))
        self.label_12.setObjectName("label_12")

        self.retranslateUi(ScanerForm)
        QtCore.QMetaObject.connectSlotsByName(ScanerForm)
        ScanerForm.setTabOrder(self.comboBox_device, self.comboBox_source)
        ScanerForm.setTabOrder(self.comboBox_source, self.comboBox_mode)
        ScanerForm.setTabOrder(self.comboBox_mode, self.comboBox_dpi)
        ScanerForm.setTabOrder(self.comboBox_dpi, self.comboBox_area)
        ScanerForm.setTabOrder(self.comboBox_area, self.spinBox_left)
        ScanerForm.setTabOrder(self.spinBox_left, self.spinBox_upper)
        ScanerForm.setTabOrder(self.spinBox_upper, self.spinBox_width)
        ScanerForm.setTabOrder(self.spinBox_width, self.spinBox_height)
        ScanerForm.setTabOrder(self.spinBox_height, self.checkBox_autosave)
        ScanerForm.setTabOrder(self.checkBox_autosave, self.comboBox_typefile)
        ScanerForm.setTabOrder(self.comboBox_typefile, self.lineEdit_path)
        ScanerForm.setTabOrder(self.lineEdit_path, self.lineEdit_filename)
        ScanerForm.setTabOrder(self.lineEdit_filename, self.pushButton_scan)
        ScanerForm.setTabOrder(self.pushButton_scan, self.pushButton_save)
        ScanerForm.setTabOrder(self.pushButton_save, self.pushButton_exit)
        ScanerForm.setTabOrder(self.pushButton_exit, self.toolButton_devreload)
        ScanerForm.setTabOrder(self.toolButton_devreload, self.spinBox_quality)
        ScanerForm.setTabOrder(self.spinBox_quality, self.toolButton_path)
        ScanerForm.setTabOrder(self.toolButton_path, self.toolButtonOpenDir)
        ScanerForm.setTabOrder(self.toolButtonOpenDir, self.list_template)
        ScanerForm.setTabOrder(self.list_template, self.pushButton_template_default)
        ScanerForm.setTabOrder(self.pushButton_template_default, self.pushButton_template_del)
        ScanerForm.setTabOrder(self.pushButton_template_del, self.pushButton_template_add)
        ScanerForm.setTabOrder(self.pushButton_template_add, self.pushButton_template_replace)
    ...
    def retranslateUi(self, ScanerForm):
        ...
        self.groupBox.setTitle(_translate("ScanerForm", "Обрезка изображения"))
        self.spinBox_left.setSuffix(_translate("ScanerForm", " мм"))
        self.spinBox_height.setSuffix(_translate("ScanerForm", " мм"))
        self.spinBox_upper.setSuffix(_translate("ScanerForm", " мм"))
        self.label_3.setText(_translate("ScanerForm", "Выбор области"))
        self.spinBox_width.setSuffix(_translate("ScanerForm", " мм"))
        self.label_9.setText(_translate("ScanerForm", "Левый"))
        self.label_10.setText(_translate("ScanerForm", "Верхний"))
        self.label_11.setText(_translate("ScanerForm", "Ширина"))
        self.label_12.setText(_translate("ScanerForm", "Высота"))
