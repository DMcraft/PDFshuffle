...
class Ui_ScanerForm(object):
    def setupUi(self, ScanerForm):
        ...
        self.spinBox_upper.raise_()
        self.label.raise_()
        self.label_2.raise_()
        self.label_3.raise_()
        self.label_4.raise_()
        self.comboBox_dpi.raise_()
        self.comboBox_area.raise_()
        self.comboBox_source.raise_()
        self.comboBox_device.raise_()
        self.groupBoxSample.raise_()
        self.pushButton_exit.raise_()
        self.toolButton_devreload.raise_()
        self.lineEdit_message.raise_()
        self.label_8.raise_()
        self.comboBox_mode.raise_()
        self.spinBox_right.raise_()
        self.spinBox_lower.raise_()
        self.label_9.raise_()
        self.groupBoxSave.raise_()
        self.pushButton_save.raise_()
        self.pushButton_scan.raise_()
        self.checkBox_autosave.raise_()
        self.spinBox_left.raise_()
        ...
        ScanerForm.setTabOrder(self.spinBox_upper, self.spinBox_right)
        ScanerForm.setTabOrder(self.spinBox_right, self.spinBox_lower)
        ScanerForm.setTabOrder(self.spinBox_lower, self.checkBox_autosave)
