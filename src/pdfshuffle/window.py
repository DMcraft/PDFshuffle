...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setMinimumSize(QtCore.QSize(600, 400))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.labelView = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.labelView.setGeometry(QtCore.QRect(1, 1, 63, 18))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonPrint.setText(_translate("MainWindow", "Печать области"))
