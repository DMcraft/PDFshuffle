...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_3.addWidget(self.checkBoxAutoSize)
        ...
        self.horizontalLayout_3.addWidget(self.spinImageSize)
        ...
        self.toolImage_3 = QtWidgets.QToolButton(self.layoutWidget1)
        self.toolImage_3.setEnabled(False)
        self.toolImage_3.setMaximumSize(QtCore.QSize(16777215, 20))
        self.toolImage_3.setObjectName("toolImage_3")
        self.tool_image_bar.addWidget(self.toolImage_3)
        self.toolImage_4 = QtWidgets.QToolButton(self.layoutWidget1)
        self.toolImage_4.setEnabled(False)
        self.toolImage_4.setMaximumSize(QtCore.QSize(16777215, 20))
        self.toolImage_4.setObjectName("toolImage_4")
        self.tool_image_bar.addWidget(self.toolImage_4)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.tool_image_bar.addItem(spacerItem3)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 484, 250))
        ...
        self.status_image_bar.addItem(spacerItem4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolImage_3.setText(_translate("MainWindow", "..."))
        self.toolImage_4.setText(_translate("MainWindow", "..."))
        ...
        self.actionTransformSelectedtoImage.setText(_translate("MainWindow", "Преобразовать выделенное в изображения"))
